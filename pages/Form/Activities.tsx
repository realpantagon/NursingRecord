...
function Activities() {
    const categories: Category[] = [
        ...
        { name: 'ดูแลพลิกตะแคงตัวทุก 2 ชม. ช่วยขับสิ่งคัดหลั่งในท่อหายใจ', key: '4' },
        { name: 'ดูแลทางเดินหายใจให้โล่ง ดูดเสมหะเมื่อมีเสมหะ และ สังเกตลักษณะสีเสมหะ', key: '5' },
        { name: 'ดูแลความสะอาดช่องปากทุกปากทุกเวร โดยใช้น้ำและ แปรงสีฟัน หรือใช้ไม้พันสำลีชุปน้ำยาบ้วนปาก', key: '6' },
        { name: 'ป้องกันการแพร่เชื้อโดยล้างมือให้สะอาด', key: '7' },
        { name: 'ดูแลความสะอาดร่างกายแบบ compleate bed bath', key: '8' },
        { name: 'ดูแลให้ได้รับยาต้านจุลชีพ ตามแผนการรักษา สังเกตผลข้างเคียงของยา ได้แก่ ปวดศีรษะ มึนงง คลื่นไส้อาเจียน ท้องเสียเป็นต้น', key: '9' },
        { name: 'ดูแลเก็บเสมหะส่งตรวจทางห้องปฏิบัติการ เพื่อประเมินการติดเชื้อ', key: '10' },
        { name: 'อื่นๆ .......', key: '11' },
    ];
